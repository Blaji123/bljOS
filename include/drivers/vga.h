...
namespace bljOS{
    namespace drivers{
        ...
        private:
            ...
            enum Color : bljOS::common::uint32_t{
                Black        = 0x1d2021,
                Red          = 0xcc241d,
                Green        = 0x98971a,
                Yellow       = 0xd79921,
            ...
            bljOS::common::uint64_t FONT[256] = {
            0x0000000000000000,
            0x0000000000000000,
            0x000000FF00000000,
            0x000000FF00FF0000,
            ...
            bljOS::common::uint32_t width;
            bljOS::common::uint32_t height;

            void drawLineLow(bljOS::common::int32_t x0, bljOS::common::int32_t y0, bljOS::common::int32_t x1, bljOS::common::int32_t y1, bljOS::common::uint32_t color);
            void drawLineHigh(bljOS::common::int32_t x0, bljOS::common::int32_t y0, bljOS::common::int32_t x1, bljOS::common::int32_t y1, bljOS::common::uint32_t color);

        protected:
            bljOS::common::uint32_t* screen;

        public:
            VideoGraphicsArray(bljOS::common::MultibootInfo* multiboot);

            void putPixel(bljOS::common::int32_t x, bljOS::common::int32_t y, bljOS::common::uint32_t color);
            void putChar(bljOS::common::uint8_t ch, bljOS::common::int32_t x, bljOS::common::int32_t y, bljOS::common::uint32_t color);
            void putStr(bljOS::common::uint8_t* ch, bljOS::common::int32_t x, bljOS::common::int32_t y, bljOS::common::uint32_t colorIndex);
            void drawLine(bljOS::common::int32_t x0, bljOS::common::int32_t y0, bljOS::common::int32_t x1, bljOS::common::int32_t y1, bljOS::common::uint32_t color);
            void drawRectangle(bljOS::common::int32_t x, bljOS::common::int32_t y, bljOS::common::uint32_t w, bljOS::common::uint32_t h, bljOS::common::uint32_t color);
            void drawCircle(bljOS::common::int32_t centerX, bljOS::common::int32_t centerY, bljOS::common::int32_t radius, bljOS::common::uint32_t color);
            void drawEllipse(bljOS::common::int32_t x0, bljOS::common::int32_t y0, bljOS::common::int32_t rx, bljOS::common::int32_t ry, bljOS::common::uint32_t color);
            void drawTriangle(bljOS::common::int32_t x0, bljOS::common::int32_t y0, bljOS::common::int32_t x1, bljOS::common::int32_t y1, bljOS::common::int32_t x2, bljOS::common::int32_t y2, bljOS::common::uint32_t color);
            void fillCircle(bljOS::common::int32_t centerX, bljOS::common::int32_t centerY, bljOS::common::int32_t radius, bljOS::common::uint32_t color);
            void fillRectangle(bljOS::common::int32_t x, bljOS::common::int32_t y, bljOS::common::uint32_t w, bljOS::common::uint32_t h, bljOS::common::uint32_t color);
            void fillEllipse(bljOS::common::int32_t x0, bljOS::common::int32_t y0, bljOS::common::int32_t rx, bljOS::common::int32_t ry, bljOS::common::uint32_t color);
            void fillTriangle(bljOS::common::int32_t x0, bljOS::common::int32_t y0, bljOS::common::int32_t x1, bljOS::common::int32_t y1, bljOS::common::int32_t x2, bljOS::common::int32_t y2, bljOS::common::uint32_t color);
        };
